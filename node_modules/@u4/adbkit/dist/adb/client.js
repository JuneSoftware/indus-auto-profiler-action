...
class Client extends events_1.default {
   ...
   */
    ...
    connection() {
        const connection = new connection_1.default(this);
    ...
    async version() {
        ...
        return new host_1.HostVersionCommand(conn).execute();
    }
    /**
    ...
    async connect(host, port = 5555) {
        ...
        const conn = await this.connection();
        return new host_1.HostConnectCommand(conn).execute(host, port);
    }
    /**
    ...
    async disconnect(host, port = 5555) {
        ...
        const conn = await this.connection();
        const deviceId = await new host_1.HostDisconnectCommand(conn).execute(host, port);
        return new DeviceClient_1.default(this, deviceId);
    }
    /**
    ...
    async listDevices() {
        const conn = await this.connection();
        return new host_1.HostDevicesCommand(conn).execute();
    }
    /**
    ...
    async listDevicesWithPaths() {
        const conn = await this.connection();
        return new host_1.HostDevicesWithPathsCommand(conn).execute();
    }
    /**
    ...
    async trackDevices() {
        const conn = await this.connection();
        return new host_1.HostTrackDevicesCommand(conn).execute();
    }
    /**
    ...
    async kill() {
        const conn = await this.connection();
        return new host_1.HostKillCommand(conn).execute();
    }
    /**
