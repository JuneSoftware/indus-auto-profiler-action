...
class ParcelReader {
    ...
    read() {
        ...
        switch (type) {
            case Parcel_1.ParcelVal.VAL_STRING:
    ...
    dump() {
        ...
        return out.join(os_1.EOL);
    }
}
exports.ParcelReader = ParcelReader;
/**
 * service call SERVICE CODE [i32 N | i64 N | f N | d N | s16 STR | null | fd f | nfd n | afd f ] ...
 */
class ServiceCallCommand extends command_1.default {
...
exports.default = ServiceCallCommand;
