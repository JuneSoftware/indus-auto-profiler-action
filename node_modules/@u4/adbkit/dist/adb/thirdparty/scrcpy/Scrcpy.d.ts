...
import { MotionEvent } from './ScrcpyConst';
...
export default class Scrcpy extends EventEmitter {
     ...
     * @returns
     */
    throwsErrors(duplex: PromiseDuplex<Duplex>): Promise<void>;
     ...
     * @param pressure
     */
    injectTouchEvent(action: MotionEvent, pointerId: bigint, position: Point, screenSize: Point, pressure?: number): Promise<void>;
