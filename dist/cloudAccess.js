...
exports.uploadResults = exports.downloadBuilds = exports.versionBundle = exports.appPath = exports.apkPath = void 0;
...
function uploadResults(path) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log('Results upload started');
            const uploadOptions = { destination: uploadDestination };
            yield storage.bucket(uploadBucketName).upload(path, uploadOptions);
